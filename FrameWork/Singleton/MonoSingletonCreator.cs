...
namespace FrameWork {	
	public static class MonoSingletonCreator
	{
		...
		public static T CreateMonoSingleton<T>() where T : UnityEngine.MonoBehaviour, ISingleton
		{
			T instance = null;
		...
		private static T CreateComponentOnGameObject<T>(string path, bool dontDestroy) where T : UnityEngine.MonoBehaviour
		{
