namespace Framework
{
    ...
    /// 基本数据类型扩展方法
    /// </summary>
    public static class BasicDataTypeExtension
    {
        #region FloatEqual
        public static bool FloatEqual(float a, float b, float precision = 0.00001f)
        {
    ...
    public static class TransformExtension
    {
        ...
        {
            selfComponent.transform.Find(tranformPath).gameObject.SetActive(true);
            return selfComponent;
        }

        public static T HideChildTransByPath<T>(this T selfComponent, string tranformPath) where T : Component
        {
            selfComponent.transform.Find(tranformPath).gameObject.SetActive(false);
            return selfComponent;
        }
